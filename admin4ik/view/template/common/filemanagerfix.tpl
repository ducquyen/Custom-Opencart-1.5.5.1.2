...
$(document).ready(function () { 
	$('#column-left').tree({
		data: { 
			...
			opts: { 
				method: 'POST', 
				url: 'index.php?route=common/filemanagerfix/directory&token=<?php echo $token; ?>'
			} 
		},
		selected: 'top',
		ui: {		
		...
		callback: {
			...
			onselect: function (NODE, TREE_OBJ) {
				$.ajax({
					url: 'index.php?route=common/filemanagerfix/files&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#create').bind('click', function () {
		...
		if (tree.selected) {
			...
			$('#dialog input[type=\'button\']').bind('click', function () {
				$.ajax({
					url: 'index.php?route=common/filemanagerfix/create&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#delete').bind('click', function () {
		...
		if (path) {
			$.ajax({
				url: 'index.php?route=common/filemanagerfix/delete&token=<?php echo $token; ?>',
				type: 'POST',
	...
	$('#move').bind('click', function () {
		...
		$('#dialog select[name=\'to\']').load('index.php?route=common/filemanagerfix/folders&token=<?php echo $token; ?>');
		...
		$('#dialog input[type=\'button\']').bind('click', function () {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?route=common/filemanagerfix/move&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#copy').bind('click', function () {
		...
		$('#dialog input[type=\'button\']').bind('click', function () {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?route=common/filemanagerfix/copy&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#rename').bind('click', function () {
		...
		$('#dialog input[type=\'button\']').bind('click', function () {
			...
			if (path) {		
				$.ajax({
					url: 'index.php?route=common/filemanagerfix/rename&token=<?php echo $token; ?>',
					type: 'POST',
					data: 'path=' + encodeURIComponent(path) + '&name=' + encodeURIComponent($('#dialog input[name=\'name\']').val()),
					dataType: 'json',
					success: function(json) {
	...
	new AjaxUpload('#upload', {
		action: 'index.php?route=common/filemanagerfix/upload&token=<?php echo $token; ?>',
		name: 'image',
		autoSubmit: false,
		responseType: 'json',
